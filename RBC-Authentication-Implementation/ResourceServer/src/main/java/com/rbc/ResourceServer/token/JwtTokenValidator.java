...
public class JwtTokenValidator {
	...
	public JwtTokenValidator(JwkProvider jwkProvider2) {
		this.jwkProvider = jwkProvider2;
    ...
    private void verifySignature(DecodedJWT decodedJWT) {
        try {
            ...
            log.info("Token's signature is correct");
...
//    private boolean hasValidAudience(JsonObject payloadAsJson) {
//		try {
//			return resource.equals(payloadAsJson.get("aud"));
//		}catch (NullPointerException ex) {
//			throw new InvalidTokenException("There is no valid resource in the token payload");
//		}
//	}
